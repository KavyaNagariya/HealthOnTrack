...
export function initializeDatabase() {
  ...
  if (trainCount.count === 0) {
    ...
    insertTrain.run('TR-002', 'Rajdhani Express', 'Delhi - Kolkata', 'Junction Station', JSON.stringify([
      'AED', 'Oxygen Tank', 'First Aid Kit', 'Pulse Oximeter', 'Stethoscope'
    ]))
    
    insertTrain.run('TR-003', 'Shatabdi Express', 'Chennai - Bangalore', 'Metro Station', JSON.stringify([
      'AED', 'Oxygen Tank', 'First Aid Kit', 'ECG Monitor', 'Nebulizer'
    ]))
  }
